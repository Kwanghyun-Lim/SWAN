...
set style line 4 lt 1 lw 3 lc rgb "dark-grey"
set style line 5 lt 1 lw 3 lc rgb "dark-green"

set output "C_Read_Latency2.png"
plot "swan.dat" using 1:2 ti "SWAN" w l ls 1, \
	"md5.dat" using 1:2 ti "RAID5" w l ls 2, \
    "md4.dat" using 1:2 ti "RAID4" w l ls 3,\
    "log_raid.dat" using 1:2 ti "LOGRAID" w l ls 4,\
    "swan_sp.dat" using 1:2 ti "SWAN-SP" w l ls 5
