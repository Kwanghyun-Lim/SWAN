...
set key at 2000000,1200000
set key box width 1.5 height 0.8
#set key horizontal
set title "YCSB-C Read"
...
#
set output "C_Read_log_raid.png"
...
#plot "md5.dat" using 1:2 ti "RAID5" w points pt 7 ps 1 lc rgb "blue"
#plot "md4.dat" using 1:2 ti "RAID4" w points pt 7 ps 1 lc rgb "blue"
plot "log_raid.dat" using 1:2 ti "LOGRAID" w points pt 7 ps 1 lc rgb "blue"
