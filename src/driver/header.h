 ...
 * filename: header.h (Borrows from SRC with little modification) 
 * 
...
#define SWAN_GC_CACHE_HOT	1 
#define SWAN_GC_CACHE_COLD	2 
#define RCBUF			3 // read cold buffer 
#define RHBUF			4 // read hot buffer 
#define GWBUF			5 // GC write buffer
#define GRBUF			6 // GC read buffer
...
#define is_write_stripe(x) (x==WCBUF||x==SWAN_GC_CACHE_HOT||x==SWAN_GC_CACHE_COLD||x==GWBUF)
#define is_read_stripe(x)  (x==RCBUF||x==RHBUF||x==GRBUF)
#define is_normal_stripe(x) (x==RCBUF || x==RHBUF || x==WCBUF|| x==SWAN_GC_CACHE_HOT || x==SWAN_GC_CACHE_COLD)
